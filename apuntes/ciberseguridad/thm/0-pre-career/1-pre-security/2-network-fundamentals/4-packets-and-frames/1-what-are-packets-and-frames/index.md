...
Un frame (o marco) está en el nivel [3. Layer 2 - Data Link](/apuntes/ciberseguridad/thm/0-pre-career/1-pre-security/2-network-fundamentals/3-osi-model/3-layer-2-data-link/), queriendo esto decir que no contiene información tal como la dirección IP. Wl frame sería, por así decirlo, el sobre de una carta (sin remitente ni destino).

Este proceso es llamado encapsulación, del que hablamos en [1. What is the OSI Model](/apuntes/ciberseguridad/thm/0-pre-career/1-pre-security/2-network-fundamentals/3-osi-model/1-what-is-the-osi-model/). En esta fase cuando hablamos de direcciones IP, estamos hablando del marco en sí. 
