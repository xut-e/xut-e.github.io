...
Cubrimos UAC en gran detalle en [7. User Account Control](/apuntes/ciberseguridad/thm/0-pre-career/1-pre-security/5-windows-fundamentals/1-windows-fundamentals-part-1/7-user-account-control/). Estos ajustes (UAC) pueden ser modificados o apagados por completo (aunque no se recomienda).
