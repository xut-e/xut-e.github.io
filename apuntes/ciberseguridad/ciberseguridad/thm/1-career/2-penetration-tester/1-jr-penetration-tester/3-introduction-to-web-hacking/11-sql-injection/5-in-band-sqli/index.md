...
>[!TIP] Si no entiendes las sentencias revisa [0. SQL Fundamentals](/apuntes/ciberseguridad/ciberseguridad/thm/0-pre-career/2-cyber-security-101/8-web-hacking/3-sql-fundamentals/0-sql-fundamentals/) y estudia SQL, es la mejor manera de entenderlo todo.
