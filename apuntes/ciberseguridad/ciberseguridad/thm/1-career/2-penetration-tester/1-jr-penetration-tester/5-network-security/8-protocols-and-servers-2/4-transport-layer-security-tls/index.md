...
En resumidas cuentas, se basa en un intercambio Diffie-Hellman. Si no sabes lo que es puedes verlo en [4. Diffie-Hellman Key Exchange](/apuntes/ciberseguridad/ciberseguridad/thm/0-pre-career/2-cyber-security-101/6-cryptography/2-public-key-cryptography-basics/4-diffie-hellman-key-exchange/).
