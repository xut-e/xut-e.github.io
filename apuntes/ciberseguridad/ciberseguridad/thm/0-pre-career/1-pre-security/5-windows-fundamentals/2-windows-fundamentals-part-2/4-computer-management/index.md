...
La sección de usuarios y grupos locales debería sonarte pues la vimos en [6. User Accounts, Profiles and Permissions](/apuntes/ciberseguridad/ciberseguridad/thm/0-pre-career/1-pre-security/5-windows-fundamentals/1-windows-fundamentals-part-1/6-user-accounts-profiles-and-permissions/). Es `lusrmgr.msc`.
