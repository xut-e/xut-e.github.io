...
Recordando [3. Identifying Devices on a Network](/apuntes/ciberseguridad/ciberseguridad/thm/0-pre-career/1-pre-security/2-network-fundamentals/1-what-is-networking/3-identifying-devices-on-a-network/), tenemos dos maneras de identificar dispositivos: IP (identificador lógico) y MAC (identificador físico).
